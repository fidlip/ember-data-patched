          ...
          if (resourceHash.hasOwnProperty(relationshipKey)) {
            ...
            if (relationshipMeta.kind === 'belongsTo') {
              if (relationshipMeta.options.polymorphic) {
                ...
                data = _this4.extractPolymorphicRelationship(relationshipMeta.type, relationshipHash, { relationshipKey: relationshipKey, resourceHash: resourceHash, relationshipMeta: relationshipMeta });
              } else {
    ...
    */
    var ember$data$lib$serializers$rest$serializer$$RESTSerializer = ember$data$lib$serializers$json$serializer$$default.extend({
      ...
      */
       ...
       */
      extractPolymorphicRelationship: function (relationshipModelName, relationshipHash, relationshipOptions) {
        var relationshipKey = relationshipOptions.relationshipKey;
